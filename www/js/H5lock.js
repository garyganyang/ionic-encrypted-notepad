(function(){
        ...
        H5lock.prototype.initDom = function(){
            ...
            var str = '<ion-content class="scroll-content ionic-scroll overflow-scroll  has-header" style="text-align: center;background-color: #00B590;"><div class="scroll"><h4 id="title" class="title">绘制解锁图案</h4>'+
                      '<a id="updatePassword" style="position: absolute;right: 5px;top: 5px;color:#fff;font-size: 10px;display:none;">重置密码</a>'+
                      '<canvas id="canvas" width="300px" height="300px" style="background-color: #00B590;display: inline-block;margin-top: 15px;"></canvas></div></ion-content>';
